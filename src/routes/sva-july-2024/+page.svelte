  ...
  import { onMount } from 'svelte';
    ...
    let slides: any = [
        ...
        },
        {
            ...
            text:
                `That relation between looking at words vs reading them makes me think of the sort of texts used when proofing typefaces. * Type designers use these to inspect the shape of words. * The meaning of the words is irrelevant, yet meaning is produced nonetheless.`
        },
        {
            imageURL: Img18,
...
<div>
    ...
    {#if count > 1}
        <button on:click={prevSlide} class="fixed left-4 w-12 h-12 top-1/2 p-1.5 border-solid border border-secondary rounded-full hover:bg-tertiary hover:text-primary hover:border-tertiary hover:[box-shadow:_0_0_2px_#3f8a9a] hover:[text-shadow:_0_0_2px_#c9c9b6] [text-shadow:_0_0_2px_#6b672e] [box-shadow:_0_0_2px_#6b672e] ">
