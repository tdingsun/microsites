...
<div>
  ...
  {:else}
    <div class="fixed top-0 left-0 m-4 text-secondary text-5xl blur-sm">
      It<br />Turned<br />From<br />Snow<br />to<br />Rain
    </div>
  {/if}
  <Slide
    slide={slides[currSlide]}
    {currClause}
    last={currClause === numClauses - 1}
  ></Slide>
  ...
  {#if currSlide === slides.length - 1}
    <div
      class="fixed top-0 left-0 w-full h-full p-4 pt-32 text-center text-secondary text-5xl blur-[1px]"
    >
      Bibligraphy
      <br /><br />
  ...
  {#if count > 1}
    <button
      on:click={prevSlide}
      class="fixed left-4 w-12 h-12 top-1/2 p-1.5 border-solid border border-secondary rounded-full hover:bg-tertiary hover:text-primary hover:border-tertiary hover:[box-shadow:_0_0_2px_#3f8a9a] hover:[text-shadow:_0_0_2px_#c9c9b6] [text-shadow:_0_0_2px_#6b672e] [box-shadow:_0_0_2px_#6b672e]"
    >
  ...
  {#if count < 205}
    <button
      on:click={nextSlide}
      class="fixed right-4 w-12 h-12 top-1/2 p-1.5 border-solid border border-secondary rounded-full hover:bg-tertiary hover:text-primary hover:border-tertiary hover:[box-shadow:_0_0_2px_#3f8a9a] hover:[text-shadow:_0_0_2px_#c9c9b6] [text-shadow:_0_0_2px_#6b672e] [box-shadow:_0_0_2px_#6b672e]"
