<script lang="ts">
  ...
  import froebel1 from "$lib/images/minecraft/sheep.jpg"
  import froebel2 from "$lib/images/minecraft/sheep.jpg"
  import froebel3 from "$lib/images/minecraft/sheep.jpg"
